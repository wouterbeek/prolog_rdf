...
'STRING_LITERAL_SINGLE_QUOTE_char'(_) --> code_radix(hex('27')), !, {fail}.
'STRING_LITERAL_SINGLE_QUOTE_char'(_) --> code_radix(hex('5C')), !, {fail}.
'STRING_LITERAL_SINGLE_QUOTE_char'(_) --> code_radix(hex('A')), !, {fail}.
'STRING_LITERAL_SINGLE_QUOTE_char'(_) --> code_radix(hex('D')), !, {fail}.
'STRING_LITERAL_SINGLE_QUOTE_char'(Code) --> [Code].
