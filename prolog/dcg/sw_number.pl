:- module(
  ...
  [
    'DECIMAL'//2, % +Language:oneof([sparql,turtle])
                  % ?Decimal:compound
    decimalLiteral//1, % ?Decimal:compound
    'DECIMAL_NEGATIVE'//1, % ?Decimal:compound
    'DECIMAL_POSITIVE'//1, % ?Decimal:compound
...
/** <module> Numbers as defined by Semantic Web languages
