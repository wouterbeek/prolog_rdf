...
/** <module> URI Syntax: Authority

Grammar for URI authorities.
...
%! authority(+Iri:boolean, ?Scheme:atom, ?Authority:compound)// .
%
% # Syntax
%
% ```abnf
...
userinfo(I, UserInfo) -->
  dcg_atom(userinfo_codes(I), UserInfo).
