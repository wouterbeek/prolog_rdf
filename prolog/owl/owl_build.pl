...
:- rdf_meta
	owl_assert_class(r, t, ?, ?, ?),
	owl_assert_data_property(r, ?),
	owl_assert_data_property(r, t, ?, ?, r, r, ?, +),
	owl_assert_disjointWith(o, o, r),
	owl_assert_equivalent_class(r, r, ?),
	owl_assert_functional_property(r, ?),
	owl_assert_intersection_of(r, t, ?),
	owl_assert_literal(o, o, o, +),
	owl_assert_named_individual(r, t, ?, ?, ?),
	owl_assert_object_property(r, r),
	owl_assert_object_property(r, t, ?, ?, r, r, r, +),
	owl_assert_ontology(r, r),
	owl_assert_value_restriction(r, r, ?, -).
...
owl_assert_class(C, D, Lbl, Comm, G) :-
  ...
  rdfs_build:rdfs_assert_class0(C, D, Lbl, Comm, G).
