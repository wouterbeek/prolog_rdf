...
:- use_module(library(xml/xsd_string)).
:- use_module(library(xml/datetime/xsd_date)).
:- use_module(library(xml/datetime/xsd_datetime)).
:- use_module(library(xml/datetime/xsd_datetime_functions)).
:- use_module(library(xml/datetime/xsd_gDay)).
:- use_module(library(xml/datetime/xsd_gMonth)).
:- use_module(library(xml/datetime/xsd_gMonthDay)).
:- use_module(library(xml/datetime/xsd_gYear)).
:- use_module(library(xml/datetime/xsd_gYearMonth)).
:- use_module(library(xml/datetime/xsd_time)).
:- use_module(library(xml/duration/xsd_duration)).
:- use_module(library(xml/duration/xsd_duration_functions)).
:- use_module(library(xml/number/xsd_decimal)).
:- use_module(library(xml/number/xsd_double)).
:- use_module(library(xml/number/xsd_float)).
